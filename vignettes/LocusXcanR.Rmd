...
An example of the R shiny application used on a real data analysis (i.e. results from TWAS and GWAS) is available in the R script `R/example/example\_script.R`.
